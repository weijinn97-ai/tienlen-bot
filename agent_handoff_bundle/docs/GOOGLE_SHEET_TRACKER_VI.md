...
Đây là tab dùng để quản lý ảnh training thô mà user hoặc agent đã gửi vào hệ thống.

Tab này trả lời:

- ảnh nào đã được nhập vào repo
- ảnh nằm ở batch nào
- file gốc tên gì
- room nào, ván nào, chế độ mở hay tắt
- đang ở trạng thái raw, đã đọc bài, hay đã gắn nhãn
- ảnh đó có thể dùng cho bước nào tiếp theo
...
4. xem `08_Image_Index` nếu làm việc liên quan ảnh hoặc training data
5. xem `01_Task_Board` để biết đang ưu tiên việc gì
6. trước khi sửa lớn, thêm một dòng vào `02_Agent_Notes`
7. nếu muốn đề xuất thay đổi, thêm một dòng vào `03_Change_Requests`
8. khi đã chốt hướng đi, ghi vào `05_Decisions`
